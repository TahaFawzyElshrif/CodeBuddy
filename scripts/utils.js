...
export function SETHFToken() {
  Swal.fire({
    ...
    input: 'text',
    inputLabel: 'لبدء استخدام البرنامج مجانًا، أنشئ حسابًا على Hugging Face ثم أنشئ Access Token وأدخله هنا. هذا يساعدنا على تقديم الخدمة مجانًا. لمعرفة المزيد، راجع صفحة الأسئلة الشائعة (FAQs : https://tahafawzyelshrif.github.io/TF-CodebuddyLearn/faq.html).',   
    inputPlaceholder: '',
